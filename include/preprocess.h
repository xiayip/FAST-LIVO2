...
#include <zwind_msg/msg/custom_msg.hpp>
...
public:
  ...
  void process(const zwind_msg::msg::CustomMsg::SharedPtr &msg, PointCloudXYZI::Ptr &pcl_out);
...
private:
  void avia_handler(const zwind_msg::msg::CustomMsg::SharedPtr &msg);
