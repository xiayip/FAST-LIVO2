...
void Preprocess::process(const zwind_msg::msg::CustomMsg::SharedPtr &msg, PointCloudXYZI::Ptr &pcl_out)
{
  avia_handler(msg);
  *pcl_out = pl_surf;
}
...
void Preprocess::avia_handler(const zwind_msg::msg::CustomMsg::SharedPtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
